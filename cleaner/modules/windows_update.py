...
class WindowsUpdateModule(CleanerModule):
    module_id = "windows_update"
    display_name = "Windows Update 快取"
    description = "已下載的 Windows 更新安裝檔快取"
    requires_admin = True
    min_age_hours = 0

    def __init__(self):
        self._root = os.path.expandvars(r"%SystemRoot%\SoftwareDistribution\Download")
